...
/*  public Nodo(int n){
	...
	public Nodo(int n, boolean ver) {
		this.v = n;
		this.ver = ver;
		this.p = this.esq = this.dir = ARBTree.nil;
	}
	...
	public Nodo encontra(int n) {
		...
		if (n < this.v && this.esq != ARBTree.nil) return this.esq.encontra(n);
		else if (n > this.v && this.dir != ARBTree.nil) return this.dir.encontra(n);
		else return this;
	}
 ...
 public Nodo maximo() {
	...
	public void inorderWalk() {
		...
		// de forma ordenada
		if (this.esq != ARBTree.nil) this.esq.inorderWalk();
		System.out.println(this.v);
		if (this.dir != ARBTree.nil) this.dir.inorderWalk();
	}

	 public Nodo predecessor() {
		// Informa o valor do Nodo que antecede (em termos de valores)
		// o atual Nodo
		if (this.esq != ARBTree.nil) return this.esq.maximo();
		else return this;
	}
	...
	public Nodo sucessor(){
		...
		// o atual Nodo
		if (this.dir != ARBTree.nil) return this.dir.minimo();
		else return this;
	}

	// a verificar
  public void encontra50(Integer q, int aux, ARBTree res) {
		if(q >= 50) return;

		if (this.esq != ARBTree.nil) {
